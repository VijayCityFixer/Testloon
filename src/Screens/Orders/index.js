                  ...
                  <View style={styles.detailsView}>
                    ...
                    {item.isOpen ? <View>
                      ...
                      <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={[styles.normalText, { color: item?.status == 'Cancelled' ? DynamicAppStyles.colorSet[COLOR_SCHEME].Red : DynamicAppStyles.colorSet[COLOR_SCHEME].Black }]}>: {item?.status}</Text>
                      </View>
                      <Button
                        style={styles.btnView[{
                          backgroundColor: item?.status == 'Cancelled' ? DynamicAppStyles.colorSet[COLOR_SCHEME].KellyGreen : DynamicAppStyles.colorSet[COLOR_SCHEME].Red,
                        }]}
                        title={item?.status == 'Cancelled' ? 'Book again' : 'Cancel order'}
                      />
                    </View> : null}
                    <TouchableOpacity onPress={() => {
                      this.state.listData[i].isOpen = !this.state.listData[i].isOpen
                      this.setState({})
                    }} style={{ alignSelf: 'flex-end' }}>
                      <Text style={{ color: DynamicAppStyles.colorSet[COLOR_SCHEME].KellyGreen }}>
                        {item.isOpen ? "Less info" : "More info"}
                      </Text>
                    </TouchableOpacity>
